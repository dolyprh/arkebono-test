    ...
    <div class="gradient-bg text-white px-8 py-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold">Master Item</h2>
                    <p class="text-blue-100 mt-1">Kelola data master item koperasi</p>
                </div>
            </div>
    ...
    <div class="p-8">
        @if($items->isEmpty())
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-600 mb-2">Tidak ada data item</h3>
                <p class="text-gray-500">Mulai dengan menambahkan item baru</p>
            </div>
        @else
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                <i class="fas fa-box mr-2"></i>Nama Item
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="itemTableBody">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <button onclick="openEditModal('{{ $item->kode }}', '{{ $item->nama_item }}', '{{ $item->harga }}')" 
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-gray-900" id="modalTitle">Tambah Item Baru</h3>
            ...
            <form id="itemForm">
                ...
                <div class="mb-4">
                    <label for="kode" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-barcode mr-2"></i>Kode Item
                    </label>
                    <input type="text" id="kode" name="kode" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="Masukkan kode item">
                    <div id="kodeError" class="text-red-500 text-sm mt-1 hidden"></div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div id="nama_itemError" class="text-red-500 text-sm mt-1 hidden"></div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div id="hargaError" class="text-red-500 text-sm mt-1 hidden"></div>
                </div>
...
<div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <p class="text-sm text-gray-500 mb-6">Apakah Anda yakin ingin menghapus item ini?</p>
...
let currentItemKode = null;
let itemToDelete = null;

function openAddModal() {
    isEditMode = false;
    currentItemKode = null;
...
function openEditModal(kode, nama_item, harga) {
    isEditMode = true;
    currentItemKode = kode;
...
document.getElementById('itemForm').addEventListener('submit', function(e) {
    ...
    const url = isEditMode ? `/item/${currentItemKode}` : '/item';
